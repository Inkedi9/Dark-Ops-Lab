...
import { ChallengeSandbox } from "@/challenges/components/sandbox/ChallengeSandbox";
import { addXp } from "@/store/global-progress";
import { appendProgressEvent } from "@dark/progress";
import { MissionStatusBar } from "@/challenges/components/MissionStatusBar";
import { AppShell } from "@/components/layout/AppShell";
import { FailIntelligencePanel } from "@/challenges/components/FailIntelligencePanel";
import { ExploitFeedbackPanel } from "@/challenges/components/ExploitFeedbackPanel";
...
export default function ChallengeRunner({ slug }: Props) {
    ...
    return (
        ...
        <AppShell>
            ...
            <PanelCard variant="darkOps" accent="danger" className="mb-8">
            ...
            <section className="grid gap-6 lg:grid-cols-[1.4fr_0.8fr]">
                ...
                <aside className="space-y-6">
                    ...
                    {solved && (
                        <PanelCard variant="darkOps" accent="emerald" className="p-6">
