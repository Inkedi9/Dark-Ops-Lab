...
const navItems = [
    { href: "/defend/soc", label: "Dashboard", icon: LayoutDashboard },
    { href: "/defend/soc/alerts", label: "Alert queue", icon: Inbox },
    { href: "/defend/soc/intel", label: "Intel", icon: Radar },
    { href: "/defend/soc/playbooks", label: "Playbooks", icon: BookOpen },
    { href: "/defend/soc/reports", label: "Case reports", icon: FileText },
    { href: "/defend", label: "Back to Defend", icon: ShieldCheck },
];
    ...
    return (
        <main className="relative min-h-screen overflow-hidden bg-[#05070A] text-slate-100">
            ...
            <aside className="fixed bottom-0 left-0 top-0 z-40 hidden w-72 border-r border-blue-300/10 bg-[#071120]/88 px-5 py-6 backdrop-blur-2xl lg:block">
                ...
                <Link href="/defend" className="mb-10 flex items-center gap-3">
