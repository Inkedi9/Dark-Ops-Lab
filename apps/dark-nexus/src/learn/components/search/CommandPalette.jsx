...
const staticPages = [
    ...
    { type: "Page", title: "Lessons", to: "/learn/lessons" },
    { type: "Page", title: "Tracks", to: "/learn/tracks" },
    { type: "Page", title: "Resources", to: "/learn/resources" },
    { type: "Page", title: "Glossary", to: "/learn/resources/glossary" },
    { type: "Page", title: "Analytics", to: "/learn/analytics" },
];
    ...
    const items = useMemo(() => {
        const handbookItems = handbookSections.flatMap((section) =>
            section.items.map((item) => ({
                ...
                to: `/learn/resources/handbook/${item.id}`,
            }))
        );
        ...
        return [
            ...
            ...tracks.map((track) => ({
                ...
                to: `/learn/tracks/${track.id}`,
            })),
            ...glossaryTerms.map((term) => ({
                type: "Glossary",
                title: term.title,
                description: term.shortDescription,
                to: `/learn/concepts/${term.id}`,
            })),
            ...handbookItems,
        ];
    }, []);
