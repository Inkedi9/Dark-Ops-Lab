...
import { BarChart3, BookOpen, GraduationCap, Library, Route, Search, Shield } from "lucide-react";

const navItems = [
    { href: "/learn", label: "Home", icon: BookOpen },
    { href: "/learn/lessons", label: "Learn", icon: GraduationCap },
    { href: "/learn/tracks", label: "Tracks", icon: Route },
    { href: "/learn/resources", label: "Resources", icon: Library },
    { href: "/learn/analytics", label: "Analytics", icon: BarChart3 },
];

function NextLink({ to, children, ...props }) {
...
export default function AppShell({ children }) {
    ...
    function navLinkClass(href) {
        ...
        return `relative hidden h-9 items-center rounded-xl px-3 py-2 text-xs font-black uppercase tracking-[0.14em] transition md:inline-flex ${
            isActive
