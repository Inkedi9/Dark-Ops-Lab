            ...
            <section className="relative grid gap-10 overflow-hidden py-14 md:grid-cols-[1.1fr_0.9fr] md:items-center md:py-20">
                ...
                <div className="relative z-10 max-w-4xl">
                    ...
                    <div className="mt-9 flex flex-wrap gap-3">
                        <AppButton to="/learn/tracks" variant="violet">
                            Start learning
                            <ArrowRight className="ml-1 h-4 w-4" />
                        </AppButton>

                        <AppButton to="/learn/resources" variant="secondary">
                            Explore resources
                        </AppButton>

                        <AppButton to="/learn/command-basics" variant="secondary">
                    ...
                    {featuredTracks.slice(0, 2).map((track) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <AppButton to="/learn/tracks" variant="violet" className="mt-5">
                                    View track
                                </AppButton>
                            </PanelCard>
                        );
            ...
            <section className="grid gap-8 pb-12 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
                ...
                <div className="text-center lg:text-left">
                    ...
                    <div className="mt-6 flex flex-wrap justify-center gap-3 lg:justify-start">
                        <AppButton to="/learn/lessons" variant="secondary">
                            Browse lessons
                        </AppButton>
                        <AppButton to="/learn/analytics" variant="blue">
                            View progress
                        </AppButton>
                    </div>
                </div>
