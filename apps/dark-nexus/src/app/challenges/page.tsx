...
import { useChallengeProgressSnapshot, useGlobalProgressSnapshot } from "@/hooks/useLocalProgressSnapshots";
...
export default function ChallengesPage() {
    ...
    const completion = totalChallenges === 0 ? 0 : Math.round((solvedCount / totalChallenges) * 100);
        ...
        <AppShell>
            <div className="relative z-10 mx-auto max-w-7xl">
                ...
                <section className="mt-8 grid gap-5 lg:grid-cols-2">
                    <Link href="/challenges/ctf" className="group block transition hover:-translate-y-1">
                    ...
                    <Link href="/challenges/warzone" className="group block transition hover:-translate-y-1">
...
function TargetMap({ completion }: { completion: number }) {
    ...
    return (
        <PanelCard variant="darkOps" accent="danger" className="p-4">
