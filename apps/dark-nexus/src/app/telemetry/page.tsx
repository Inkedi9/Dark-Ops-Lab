    ...
    return (
        <main className="relative min-h-screen overflow-hidden bg-[#080d1a] px-4 py-8 text-slate-100 sm:px-6 lg:px-8">
            ...
            <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col gap-6">
                ...
                <PanelCard variant="darkNexusHero" accent="violet" className="p-6 lg:p-7">
                ...
                <section className="grid gap-5 xl:grid-cols-[1.15fr_0.85fr]">
                    ...
                    <PanelCard variant="darkNexusHero" accent="emerald" className="p-6">
                ...
                <PanelCard variant="darkNexusHero" accent="amber" className="p-6">
