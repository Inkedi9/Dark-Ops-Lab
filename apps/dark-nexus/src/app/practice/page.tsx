                ...
                <header className="grid gap-8 py-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                    <div>
                        ...
                        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                            <AppButton href="https://darkchallenges.vercel.app" variant="primary">
                                Launch Login Bypass →
                            </AppButton>
                    ...
                    <PanelCard variant="darkNexusHero" accent="danger">
                        ...
                        <div className="space-y-4 text-sm leading-6 text-slate-300">
                            ...
                            <div className="rounded-2xl border border-white/[0.07] bg-white/[0.035] p-4">
                                ...
                                <p className="mt-2 font-semibold text-white">
                                    DarkNexus recommends the matching defense simulation so the
...
function MissionRow({
    ...
    return (
        <a
            href={isRecommended ? "https://darkchallenges.vercel.app" : "#"}
