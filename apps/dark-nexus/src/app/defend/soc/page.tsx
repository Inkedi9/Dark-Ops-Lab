...
import SocAlertDetail from "@/defend/components/soc/SocAlertDetail";
import SocResponseActions from "@/defend/components/soc/SocResponseActions";
...
function bridgeVariant(label: string) {
...
export default function SocPage() {
    ...
    function submitVerdict(verdict: string) {
        setVerdicts((current) => ({ ...current, [selectedAlert.id]: verdict }));
    }
        ...
        <SocLayout>
            <>
                <section className="mb-8">
                    ...
                    <h1 className="text-5xl font-black tracking-tight text-white">SOC Command Center</h1>
                ...
                <section className="grid gap-6 xl:grid-cols-[0.9fr_1.4fr_0.8fr]">
                    <PanelCard variant="darkOps" accent="emerald" className="h-fit">
                        ...
                        <div className="mb-5 flex items-center justify-between">
                            <p className="font-mono text-xs uppercase tracking-[0.3em] text-blue-200">Queue</p>
                    ...
                    <aside className="space-y-6">
                        <PanelCard variant="darkOps" accent="emerald">
                            <div className="mb-4 flex items-center gap-2 text-blue-200">
                                <Eye size={18} />
                                <p className="font-mono text-xs uppercase tracking-[0.3em]">Signals</p>
                            </div>
                            <div className="space-y-3">
                                {(selectedAlert.signals as string[]).map((signal) => (
                                    <div
                                        key={signal}
                        ...
                        <PanelCard variant="darkOps" accent="violet">
                            <div className="mb-4 flex items-center gap-2 text-indigo-200">
                                ...
                                <p className="font-mono text-xs uppercase tracking-[0.3em]">Analyst note</p>
                            </div>
                            <textarea
