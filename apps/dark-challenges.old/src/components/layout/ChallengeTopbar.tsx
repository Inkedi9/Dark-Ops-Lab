...
import { Crosshair, Database, Flag, Flame, RadioTower, Shield, Swords, Terminal } from "lucide-react";
...
const navItems = [
    ...
    { href: "/challenges", label: "Missions", icon: Crosshair },
    { href: "/ctf", label: "CTF", icon: Flag },
    { href: "/warzone", label: "Warzone", icon: Flame },
    { href: "https://dark-nexus.vercel.app", label: "Nexus", external: true, icon: RadioTower },
];
...
export default function ChallengeTopbar({ level, rank }: Props) {
    ...
    function navClass(href: string) {
        const active = href.startsWith("http") ? false : href === "/" ? pathname === "/" : pathname.startsWith(href);
                ...
                <div className="relative flex items-center gap-4 px-5 py-3.5 md:px-6">
                    ...
                    <nav className="ml-auto hidden items-center gap-2 md:flex">
                        ...
                        <a
                            ...
                            className="grid h-11 w-11 place-items-center rounded-2xl border border-red-300/14 bg-red-300/[0.055] text-red-100 transition hover:border-red-200/28 hover:bg-red-300/[0.10]"
                        >
