export default function ChallengeFooter() {
    return (
        <footer className="relative z-10 -mx-6 mt-20 border-t border-white/[0.06] bg-[#05070A]/90 backdrop-blur-xl">
            <div className="mx-auto max-w-7xl px-6 py-12">
                <div className="grid gap-6 md:grid-cols-2 md:items-center">
                    <div>
                        <p className="text-lg font-extrabold text-white">DarkChallenges</p>
                        <p className="mt-2 max-w-xl text-sm text-slate-400">
                            Unguided offensive labs, CTF operations and safe simulated attack scenarios.
                        </p>
                    </div>

                    <div className="flex flex-col gap-2 md:items-end">
                        <p className="font-mono text-xs text-emerald-300">
                            FRONTEND ONLY • SAFE MOCKED TARGETS
                        </p>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="mt-5 inline-flex items-center gap-2 rounded-xl border border-indigo-300/20 bg-indigo-400/[0.07] px-5 py-3 font-bold text-indigo-100 transition hover:-translate-y-[1px] hover:bg-indigo-400/[0.12]"
                        >
                            <DiscordIcon />
                            Join Discord
                        </a>
                ...
                <div className="mt-8 border-t border-white/10 pt-6 text-center text-xs text-slate-600">
                    © {new Date().getFullYear()} DarkChallenges — Educational project
                </div>
            </div>
        </footer>
    );
...
function DiscordIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5 fill-indigo-200">
